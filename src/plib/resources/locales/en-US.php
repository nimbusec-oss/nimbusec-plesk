...
$messages = [
	...
	"dashboard.view.automatic_quarantine.hint" => "By having an automaitic cron job running in background, all new issues will be moved into quarantine. " . 
	...
	/* for an issue */
	"dashboard.view.occured_on" => "Occured On",
